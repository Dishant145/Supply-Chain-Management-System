...
<div class="wrapper">
    <div class="sidebar">
        <h3>Inventory</h3>
        <ul>
            <li><a href="retailer.php"><i class="fas fa-home"></i>Home</a></li>
    ...
    if (isset($_SESSION['rcart'])) {
        $rname = $_SESSION['rcart'];
        $query = mysqli_query($conn,"SELECT c_name, c_category, c_price, c_quantity, c_wholesaler FROM $rname");
        ...
        <thead class="theading">
                <tr> 
                    ...
                    <th> <font face="Arial">Wholesaler</font> </th>
                </tr></thead>';
