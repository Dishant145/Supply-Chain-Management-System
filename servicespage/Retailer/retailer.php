...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content">
            ...
            <a href="/Project Code/servicespage/Retailer/funds.php" class="btn"> Choose <span class="fas fa-chevron-right"></span> </a>
        </div>
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <a href="/Project Code/servicespage/Retailer/inventory.php" class="btn"> Choose <span class="fas fa-chevron-right"></span> </a>
    </div>
    <div class="image">
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem sed autem vero? Magnam, est laboriosam!</p>
        <a href="/Project Code/servicespage/Retailer/choice.php" class="btn"> Choose <span class="fas fa-chevron-right"></span> </a>
    </div>
</section>
